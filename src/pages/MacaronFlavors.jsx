...
function MacaronFlavors() {
  const flavors = [
    ...
    },
    {
      ...
      image:
        "/assets/img/LADUREE_24-02-23_pmonetta-8768_c88409cc-7252-4823-ace0-01aeb9a3769e.avif",
    },
    {
      id: "raspberry",
      name: "Raspberry",
    ...
    },
    {
      ...
      allergens: "Almond, Egg",
      image:
        "/assets/img/Ambiance_Macaron_Amande_7_Pierre_Monetta_-_20220225.avif",
    },
    {
      id: "coffee",
      name: "Coffee",
  ...
  return (
    <div className="min-h-screen bg-[#fefbf4] pt-[92px]">
      <div className="garamond mx-auto max-w-[900px] px-6 pt-16 pb-14 text-center">
        <h1 className="text-[44px] uppercase tracking-[0.1em] text-[#2e2c2a] sm:text-[64px] lg:text-[76px]">
          MACARONS FLAVORS
        </h1>
        <p className="mx-auto mt-4 max-w-[650px] text-[15px] italic text-[#5c5752] sm:text-[17px]">
          Are you a macaron lover? Indulge in subtle flavors with delicate
          textures that come together to create moments of sweet happiness.
        </p>
      </div>
      <div className="garamond mx-auto max-w-[1240px] px-6 pb-20">
        <div className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2">
          {flavors.map((flavor) => (
            ...
            >
              <div className="h-[200px] w-full flex-shrink-0 overflow-hidden bg-[#faf6ec] sm:h-[180px] sm:w-[180px]">
                <img
                  src={flavor.image}
                  alt={flavor.name}
      ...
      <div className="border-t border-[#e5dfd5] bg-[#fefbf4] py-16">
        <div className="garamond mx-auto grid max-w-[1240px] grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2">
          <div className="text-center lg:text-left">
            ...
            <h2 className="mt-3 text-[36px] uppercase tracking-wide text-[#2e2c2a] sm:text-[46px]">
              CUSTOMIZE YOUR MACARONS GIFT BOX
            </h2>
        ...
        <div className="garamond mx-auto grid max-w-[1240px] grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2">
          ...
          <div className="order-1 text-center lg:order-2 lg:text-left">
            ...
            <h2 className="mt-3 text-[34px] uppercase tracking-wide text-[#2e2c2a] sm:text-[44px]">
              THE ART OF THE LADURÉE MACARON
            </h2>
            <div className="laduree-dotted-v my-8 hidden h-[60px] w-4 lg:block" />
            <p className="text-[15px] leading-relaxed text-[#5c5752]">
              Two delicate almond shells, a soft ganache heart, and a texture
              perfected over generations. From timeless flavours like Vanilla
              and Pistachio to seasonal creations, each Ladurée macaron carries
              a piece of the house’s history in every bite.
            </p>
            <div className="mt-8">
              <Link
